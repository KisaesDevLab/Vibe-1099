...
- **Licensing:** PolyForm Internal Use 1.0.0; commercial features (client-portal access) are gated behind a license flag. Per project memory, the licensing server (`licensing.kisaes.com`) is a later phase and activation is gated by a `license_required=0` flag for now.
